...
import { loginAccount, schemaIn, clearError } from "../reducer"; // Импортируйте действие clearError
  ...
  return (
    <div className="signin">
      ...
      <form className="signin-form" onSubmit={handleSubmit(submitFormIn)}>
        <label className="signin__descriptioninput">Email address
          <input
        ...
        <label className="signin__descriptioninput">Password
          <input
      ...
      <div className="signin__description">Don't have an account? <Link className="link" to="/sign-up">Sign Up</Link></div>
    </div>
  );
}
