...
import { schemaNewArticle } from "../yup";
  ...
  return (
    <div className="newarticle">
      ...
      <form onSubmit={handleSubmit(submitFormNewArticle)}>
        <label className="newarticle__descriptioninput">
          Title
          <input
            className={`newarticle__input ${errors.title ? "error" : ""}`}
            type="text"
            name="title"
            placeholder="Title"
            {...register("title")}
        ...
        <label className="newarticle__descriptioninput">
          Short description
          <input
            className={`newarticle__input ${errors.description ? "error" : ""}`}
            type="text"
            name="description"
            placeholder="Title"
        ...
        <label className="newarticle__descriptioninput">
          Text
          <textarea
            className={`newarticle__textarea ${errors.body ? "error" : ""}`}
            type="text"
            name="body"
            placeholder="Text"
            description="true"
